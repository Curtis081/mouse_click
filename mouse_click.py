...
def is_click_time_enabled(start_time, end_time):
...
def get_time_from_user(prompt, default_time=None):
...
def get_validated_time_range(prompt_start, prompt_end, default_start_time, default_end_time):
...
def get_delay_time(prompt, default_delay=180):
